...
// Variable and function to capture the pixels already scrolled on the screen. Fed into updatePositions
var lastScrollY = 0;
...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    items[i].style.transform = 'translateX(' + 600 * phase + 'px'; //Used transform property for performance boost
  }
